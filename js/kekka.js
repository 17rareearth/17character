...
window.onload = function () {
  ...
  const elements = [
    {
      ...
      image: "Sc2.png", partnerImage: "Nd.png",
    ...
    },
    {
      ...
      image: "Y2.png", partnerImage: "Eu.png",
    ...
    },
    {
      ...
      image: "La2.png", partnerImage: "Ce0.png",
      catch: "未来を照らす、安定の蓄電池",
      ...
      E: 4.5, A: 4.1, S: 3, C: 3.5
    },
    {
      name: "セリウム", symbol: "Ce", emoji: "⚙",
      image: "Ce2.png", partnerImage: "Pr2_2.png",
    ...
    },
    {
      ...
      image: "Pr2.png", partnerImage: "Gd0.png",
      ...
      E: 2.4, A: 4, S: 4.2, C: 3.2
    },
    {
      name: "ネオジム", symbol: "Nd", emoji: "🧲",
      image: "Nd2.png", partnerImage: "Dy.png",
      ...
      E: 3.6, A: 4.8, S: 3.6, C: 3.2
    },
    {
      name: "プロメチウム", symbol: "Pm", emoji: "🔬",
      image: "Pm2.png", partnerImage: "Sm.png",
      ...
      E: 1.5, A: 4.4, S: 3.2, C: 2.8
    },
    {
      name: "サマリウム", symbol: "Sm", emoji: "🔥",
      image: "Sm2.png", partnerImage: "Pm0.png",
      ...
      E: 2.4, A: 3.0, S: 3.6, C: 4.6
    },
    {
      name: "ユウロピウム", symbol: "Eu", emoji: "✨",
      image: "Eu3.png", partnerImage: "Y0.png",
    ...
    },
    {
      ...
      image: "Tb.png", partnerImage: "Gd0.png",
      ...
      E: 2.6, A: 2.8, S: 4.7, C: 3.3
    },
    {
      name: "ジスプロシウム", symbol: "Dy", emoji: "🛡",
      image: "Dy2.png", partnerImage: "Nd.png",
      ...
      E: 1.8, A: 2.6, S: 5, C: 3.9
    },
    {
      name: "ホルミウム", symbol: "Ho", emoji: "🎯",
      image: "Ho2.png", partnerImage: "Er.png",
      ...
      E: 1.3, A: 2.2, S: 4.8, C: 4.1
    },
    {
      name: "エルビウム", symbol: "Er", emoji: "📡",
      image: "Er2.png", partnerImage: "Ho.png",
      ...
      E: 2.9, A: 4.5, S: 4.2, C: 2.6
    },
    {
      name: "ツリウム", symbol: "Tm", emoji: "🌫",
      image: "Tm2.png", partnerImage: "Yb0.png",
    ...
    },
    {
      ...
      image: "Gd2.png", partnerImage: "Tb00.png",
  ...
  const weights = elements.map(el => {
    const distSq =
      ...
      (user.S - el.S) ** 2 +
      (user.C - el.C) ** 2;
    let similarity = Math.exp(-distSq / (2 * sigma * sigma));

    // ★当選分布のバランス調整（出すぎキャラへのブレーキ）
    if (el.name === "イットリウム") similarity *= 0.7;
    if (el.name === "スカンジウム") similarity *= 0.8;

    el.rawSimilarity = similarity;
    el.score = Math.round(similarity * 100);
    return similarity;
  });

  function getWeightedRandomIndex(w) {
  ...
  const winnerIndex = getWeightedRandomIndex(weights);
  const winner = elements.splice(winnerIndex, 1)[0];
  elements.unshift(winner);

  const secondThird = elements.slice(1).sort((a, b) => b.score - a.score);
  elements.splice(1, elements.length - 1, ...secondThird);

  // 🌟 スコア表示調整（不信感のない数字へ）
  elements[0].score = Math.max(85, Math.min(98, elements[0].score + 20));
  elements[1].score = Math.max(60, Math.min(elements[0].score - 5, elements[1].score + 15));
  elements[2].score = Math.max(50, Math.min(elements[1].score - 5, elements[2].score + 10));
  ...
  let html = `
    ...
    <div class="resultCard" style="padding:15px; border-top:4px solid #bdc3c7; display:flex; align-items:center; gap:15px;">
      ...
      <div style="text-align:left;">
        ...
        <p style="font-size:13px; margin:0;">${top2.short}</p>
      </div>
    </div>
    <div class="resultCard" style="padding:15px; border-top:4px solid #bdc3c7; display:flex; align-items:center; gap:15px; margin-top:10px;">
      ...
      <div style="text-align:left;">
        ...
        <p style="font-size:13px; margin:0;">${top3.short}</p>
      </div>
    </div>
  `;

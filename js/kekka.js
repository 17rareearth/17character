...
// 3. 軸計算（加点方式で、C軸の不一致を厳しく判定）
  elements.forEach(el => {
    ...
    [
      ...
      let point = 0;
      if (diff < 0.4) point = 25;      // ほぼ一致
      else if (diff < 0.8) point = 15; // 近い
      else if (diff < 1.3) point = 5;  // 遠い
